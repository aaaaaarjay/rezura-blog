...
const Educationaltour = () => {
    return (
        <div
            ...
            id="educationaltour"
        >
            <h1 className="text-[40px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 mt-20 mb-[40px]">
                Educational Tour
            </h1>
            <div className="rounded-lg shadow-lg border border-[#2A0E61] p-10 w-[1050px]">
            <EmblaCarousel />
            </div>
            ...
            <div className="text-[20px] text-gray-200 mb-10 text-center px-64 md:px-62">
